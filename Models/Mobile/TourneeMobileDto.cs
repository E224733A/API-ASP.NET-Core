...
public class TourneeMobileDto
{
    ...
    public IList<ArticleSaisissableDto> ArticlesSaisissables { get; init; } = new List<ArticleSaisissableDto>();
...
public class SaisieMobileDto
{
    ...
    public IList<QuantiteSaisieMobileDto> Quantites { get; init; } = new List<QuantiteSaisieMobileDto>();
}
