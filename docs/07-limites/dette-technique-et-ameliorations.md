...
Ce document décrit honnêtement les limites techniques connues du dépôt `servewebEXPE` et propose une trajectoire d’amélioration progressive.

L’objectif n’est pas de dévaloriser le projet, mais de faciliter sa reprise sans cacher les points perfectibles.
